...
const ContactMe = () => {
  ...
  <section className="mb-32">
    ...
    <div className="container px-6 md:px-12">
      <div
        className="block rounded-lg bg-[hsla(0,0%,100%,0.7)] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-[hsla(0,0%,1%,.7)] dark:shadow-black/20 md:py-16 md:px-12 -mt-[100px] backdrop-blur-[30px]">
        <div className="mb-12 grid gap-x-6 md:grid-cols-1 lg:grid-cols-3">
          ...
          <div className="mx-auto mb-6 text-center md:mb-0">
            ...
            <h6 className="font-medium text-white text-md"><a href="tel:+918239279999">+91 8239279999</a></h6>
          </div>
        </div>
      </div>
    </div>
